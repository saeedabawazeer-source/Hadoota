...
export const allSubjects = {
  Math: { title: 'Pirate Math!', icon: '/icons/Item/Book/64px/Blue Book 1st 64px.png', questions: mathQuestions },
  Spelling: { title: 'Word Ninja!', icon: '/icons/Item/Pencil/64px/Blue Pencil 1st 64px.png', questions: spellingQuestions },
  Logic: { title: 'Brain Teasers!', icon: '/icons/Item/Dice/64px/Dice 1st 64px.png', questions: logicQuestions },
  Science: { title: 'Science Lab!', icon: '/icons/Item/Potion/64px/Blue Potion 1st 64px.png', questions: scienceQuestions },
  Geography: { title: 'World Explorer!', icon: '/icons/Nature/Planet/64px/Golden Planet 1st 64px.png', questions: geographyQuestions },
  Memory: { title: 'Memory Master!', icon: '/icons/Item/Crown/64px/Crown 1st 64px.png', questions: memoryQuestions },
};
